...
This script compares the migrated code with the original convert-matinvent
...
class TestBenchmarkComparison(unittest.TestCase):
    """Test cases for comparing with convert-matinvent benchmarks."""
    ...
    def test_convert_matinvent_exists(self):
        """Test convert-matinvent directory exists."""
        self.assertTrue(
            os.path.exists(self.convert_dir),
            f"convert-matinvent directory not found: {self.convert_dir}"
        )
...
def print_comparison_summary():
    ...
    print()
    print("📋 基准测试脚本位置:")
    print("  - convert-matinvent/diff_info/benchmark_mattergen.py")
    print("  - convert-matinvent/diff_info/benchmark_diffcsp.py")
    print("  - convert-matinvent/diff_info/benchmark_rl.py")
    print()
    print("🎯 迁移目标:")
