#!/usr/bin/env python3
"""
简化的 DiffCSP 基准测试脚本 - PaddlePaddle版本
...
def run_full_benchmark(device: str = "gpu:0"):
    ...
    logger.info("=" * 60)
    logger.info("DIFFCSP BENCHMARK SUITE (PaddlePaddle - Simplified)")
    logger.info("=" * 60)
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="DiffCSP Benchmark Suite (PaddlePaddle - Simplified)")
