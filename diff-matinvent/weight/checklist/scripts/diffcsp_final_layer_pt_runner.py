...
特别注意：
本脚本只能在 matinvent 的独立环境里运行，避免直接在 ppmat 环境下执行。

用法（由 diffcsp_final_layer_infer_and_diff.py 通过 subprocess 调用）：
  python diffcsp_final_layer_pt_runner.py <RAW_ROOT> <INPUT_JSON> <PT_CKPT> <OUT_JSON>
